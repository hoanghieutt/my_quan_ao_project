            ...
            <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                <div class="bg-white py-2 collapse-inner rounded">
                    <h6 class="collapse-header" style="color: black; font-size: 13px;">Pages</h6>
                                        ...
                                        <a class="collapse-item"  href="">Hóa đơn chi tiết</a>
    ...
    <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
            ...
            <div>
                ...
                <h1 style="text-align: center; color: black; margin-top: 250px; margin-bottom: 320px">Xin lỗi hiện đang cập nhật !</h1>
