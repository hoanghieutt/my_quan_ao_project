        ...
        <div id="content">
            ...
            <div class="bill_dat_hang">
                ...
                <div class="order-details">
                    ...
                    <p><strong>Ma don hang:</strong> ${hoaDon.maHD}</p>
                    <p><strong>Thanh tien:</strong> ${tong} <span>VND</span></p>
                    <p><strong>Ngay tao:</strong> ${hoaDon.ngayTao}</p>
                    <p><strong>Ten nguoi nhan:</strong> ${hoaDon.tenNguoiNhan}</p>
                    <p><strong>Dia chi nhan hang:</strong> ${hoaDon.diaChiNhanHang}</p>
                    <p><strong>So dien thoai:</strong> ${hoaDon.soDienThoai}</p>
                </div>
