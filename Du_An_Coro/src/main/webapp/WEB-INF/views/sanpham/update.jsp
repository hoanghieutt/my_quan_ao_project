        ...
        <div id="content">
            ...
            <div>
                ...
                <frm:form action="${action}" method="post" modelAttribute="sp">
                    ...
                    <div class="row">
                        <div class="col-6">
                            <label style="margin-left: 150px; margin-bottom: 30px" >Image</label>
<%--                            <frm:input name="imageProduct"  value="" type="file"/>--%>
                            <frm:input name="imageProduct" path="image" type="file"/>
                        </div>
                        <div class="col-6">
                        ...
                        <div class="col-6">
                            <label style="margin-left: 150px; margin-right: 33px; margin-bottom: 30px" >Số lượng</label>
                            <frm:input path="soluong" cssStyle="width: 250px;" min="1" value=""/>
                                <%--                                <div class="textTitle"><frm:errors cssStyle="margin-left: 400px; color: red" class="errors" path="name" /></div>--%>
                        </div>
